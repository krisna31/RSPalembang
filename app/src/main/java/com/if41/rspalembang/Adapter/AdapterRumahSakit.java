...
public class AdapterRumahSakit extends
    ...
    public AdapterRumahSakit(Context ctx, List<ModelRumahSakit>
            listRumahSakit) {
        this.ctx = ctx;
    ...
    public HolderData onCreateViewHolder(@NonNull ViewGroup
                                                 parent, int viewType) {
        View view =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_rumah_sakit, parent, false);
        HolderData holder = new HolderData(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull HolderData holder, int
            position) {
                ...
                public boolean onLongClick(View view) {
                    ...
                    dialog.setPositiveButton("Ubah", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface
                            ...
                            intent.putExtra("xAlamat",
                                    tvAlamat.getText().toString());
                            intent.putExtra("xTelepon",
                                    tvTelepon.getText().toString());
